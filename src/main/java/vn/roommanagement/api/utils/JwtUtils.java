package vn.roommanagement.api.utils;
...
public class JwtUtils {
    ...
    public String generateToken(String jwtSecret, String userId, long time) {
    ...
    public Boolean isActiveToken(String token, String userId) {
        Optional<UserToken> userTokenOpt = repository.findByTokenAndUserId(token, userId);
